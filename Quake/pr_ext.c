...
#define PF_NoCSQC NULL
{
	...
	{"strlen",					PF_vr_strlen,					PF_vr_strlen,					97,		"float(string s)"},
	...
	{"sin",						PF_vr_sin,						PF_vr_sin,						102,	"float(float x)"},
	{"cos",						PF_vr_cos,						PF_vr_cos,						103,	"float(float x)"},
	{"asin",						PF_vr_asin,						PF_vr_asin,						104,	"float(float x)"},
	{"acos",						PF_vr_acos,						PF_vr_acos,						105,	"float(float x)"},
	{"tan",						PF_vr_tan,						PF_vr_tan,						106,	"float(float x)"},
	{"atan",						PF_vr_atan,						PF_vr_atan,						107,	"float(float x)"},
	{"sqrt",						PF_vr_sqrt,						PF_vr_sqrt,						108,	"float(float x)"},
